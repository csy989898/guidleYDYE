package com.example.administrator.ydyeapplication.guidePage;
...
public class GuideMoreActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        LayoutInflater lf = getLayoutInflater().from(GuideMoreActivity.this);
    ...
    private void initView() {
        ...
        mBtn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GuideMoreActivity.this, MainActivity.class));
                finish();
            }
        });
    }
